...
class VisionQ4 extends React.Component {
  ...
  handleSubmit() {
    if (this.state.answer.trim() === '') {
      ...
      storeAnswer("Q4", this.state.answer);
      this.props.navigation.navigate('VisionQ5');
    }
  }
        ...
        <SafeAreaView style={styles.container}>
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.inner}>
              ...
              <Text style={styles.question}>Q4. What number do you see in the circle below?</Text>
              ...
              <TouchableOpacity
                style={styles.back}
                onPress={() => this.props.navigation.navigate('VisionQ3')}
              >
