...
class VisionQ13 extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit() {
    if (this.state.answer.trim() === '') {
      ...
      storeAnswer("Q13", this.state.answer);
        ...
        <SafeAreaView style={styles.container}>
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.inner}>
              ...
              <Text style={styles.question}>Q18. What number do you see in the circle below?</Text>
              <Text style={styles.subtext}>(If you are unsure, enter 0)</Text>
              <Image
                source={require('./images/plate13.png')} 
                style={styles.image}
              />
              ...
              <TouchableOpacity
                style={styles.back}
                onPress={() => this.props.navigation.navigate('VisionQ12')}
              >
