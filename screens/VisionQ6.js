...
class VisionQ6 extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit() {
    if (this.state.answer.trim() === '') {
      ...
      storeAnswer("Q6", this.state.answer);
      this.props.navigation.navigate('VisionQ7');
    }
  }
        ...
        <SafeAreaView style={[styles.container, {backgroundColor: this.props.global.theme}]}>
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.inner}>
              ...
              <Progress.Bar progress={0.59} width={300} height={10} />
              <Text style={[styles.question, {color: this.props.global.textTheme}]}>Q6. What number do you see in the circle below?</Text>
              <Text style={[styles.subtext, {color: this.props.global.textTheme}]}>(If you are unsure, enter 0)</Text>
              <Image
                source={require('./images/plate6.png')} 
                style={styles.image}
              />
              ...
              <TouchableOpacity
                style={styles.back}
                onPress={() => this.props.navigation.navigate('VisionQ5')}
              >
...
export default withGlobalContext(VisionQ6);
