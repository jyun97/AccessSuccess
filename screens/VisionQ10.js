...
class VisionQ10 extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit() {
    if (this.state.answer.trim() === '') {
      ...
      storeAnswer("Q10", this.state.answer);
        ...
        <SafeAreaView style={styles.container}>
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.inner}>
              ...
              <Text style={styles.question}>Q15. What number do you see in the circle below?</Text>
              <Text style={styles.subtext}>(If you are unsure, enter 0)</Text>
              <Image
                source={require('./images/plate10.png')} 
                style={styles.image}
              />
