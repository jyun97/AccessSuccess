...
class MultipleChoice extends React.Component{
    ...
    onAnswerChange(choiceNum){
        if(this.state.selectedChoice === choiceNum){
            ...
            storeAnswer("onOff", JSON.stringify(choiceNum))
        }
    }
...
class OnOffLabel extends React.Component {
    constructor(props) {
        super(props);
    }
    render() {
    ...
    <SafeAreaView style={[{alignItems:"center"}, {backgroundColor: this.props.global.theme}]}>
        ...
        <Progress.Bar progress={0.24} width={300} height={10} />
        <Text style={[styles.question, {color: this.props.global.textTheme}]}>Q5. Select the option you prefer.</Text>
        <MultipleChoice/>
...
export default withGlobalContext(OnOffLabel)
