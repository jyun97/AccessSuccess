...
class VisionQ8 extends React.Component {
  ...
  handleSubmit() {
    if (this.state.answer.trim() === '') {
      ...
      this.props.navigation.navigate('VisionQ9Instr');
    }
  }
        ...
        <SafeAreaView style={[styles.container, {backgroundColor: this.props.global.theme}]}>
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.inner}>
              ...
              <Progress.Bar progress={0.71} width={300} height={10} />
              <Text style={[styles.question, {color: this.props.global.textTheme}]}>Q8. What number do you see in the circle below?</Text>
...
export default withGlobalContext(VisionQ8);
