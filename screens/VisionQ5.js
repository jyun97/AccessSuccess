...
class VisionQ5 extends React.Component {
  ...
  handleSubmit() {
    if (this.state.answer.trim() === '') {
      ...
      storeAnswer("Q5", this.state.answer);
      this.props.navigation.navigate('VisionQ6');
    }
  }
        ...
        <SafeAreaView style={styles.container}>
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.inner}>
              ...
              <Text style={styles.question}>Q5. What number do you see in the circle below?</Text>
              ...
              <TouchableOpacity
                style={styles.back}
                onPress={() => this.props.navigation.navigate('VisionQ4')}
              >
